...
INSERT INTO character (id, nombre, frase ,descripcion, ruta_imagen) VALUES(2, 'Ghost', '¿Has visto mi linterna?', 'Lleva una linterna y se cree de lo mejor, tss', 'ghost.jpg');
INSERT INTO character (id, nombre, frase ,descripcion, ruta_imagen) VALUES(3, 'Bestia', '¿¿garrra ggaarrr garrrrrarrr?', 'No se entera de nada', 'bestia.jpg');
INSERT INTO character (id, nombre, frase ,descripcion, ruta_imagen) VALUES(4, 'Esqueleto', '¿Cuanto llevo muerto?', 'En su dia fui una leyenda', 'esqueleto.jpg');
